...
## system prompt for generating tweet
prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                Write a tweet that has relevant content as per the idea from user, with consistent brand image and proper tone.""",
            ),
            ("human", "{chat_message}"),
        ]
    )
...
## page title
st.set_page_config(page_title="Create a Tweet")
...
## User input
chat_message = st.chat_input("What's your tweet idea (should be related to Spillmate)")
